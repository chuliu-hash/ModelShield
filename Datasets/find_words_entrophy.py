...
if __name__ == '__main__':
    input_list=read_list_from_file('/data3/WaterMarking/wild_dataset/instinwild_en_4000.json')
    ...
    dic2json(empty_list,'/data3/WaterMarking/wild_dataset/wild_human_sorted_frequency.json')
